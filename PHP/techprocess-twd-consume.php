            ...
            <form method="post">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="CONSUME" name="txnSubType" readonly>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <!-- <td><input type="text" name="itc" value="itc:NIC~TXN0001~122333~rt14154~8 mar 2014~Payment~forpayment" /></td> -->
