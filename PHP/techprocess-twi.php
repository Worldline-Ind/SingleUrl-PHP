            ...
            <form method="post">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="TWI" name="reqType" readonly>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="mmid" value="1231221" required /></td>
                    </tr>
                    <tr>
                        <td><label><span style="color:red">*</span> OTP</label></td>
                        <td><input type="text" name="otp" value="123123" required /></td>
                    </tr>
                    <tr>
