...
if ($_POST && isset($_POST['submit'])) {
    ...
    $log  = "Name : ".$transactionRequestBean->customerName."; Date : ".date("F j, Y, g:i a")."; Request Data : ".$transactionRequestBean->merchantCode."|".$transactionRequestBean->requestType."|".$transactionRequestBean->TPSLTxnID."|".$transactionRequestBean->cardCVV."|".$transactionRequestBean->key."|".$transactionRequestBean->iv."|".$transactionRequestBean->webServiceLocator.PHP_EOL;
            ...
            <form method="post">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="TIR" name="reqType" readonly>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="cardCVV" required /></td>
                    </tr>
