...
if ($_POST && isset($_POST['submit'])) {
    ...
    $log  = "Name : ".$transactionRequestBean->customerName."; Date : ".date("F j, Y, g:i a")."; Request Data : ".$transactionRequestBean->merchantCode."|".$transactionRequestBean->ITC."|".$transactionRequestBean->customerName."|".$transactionRequestBean->requestType."|".$transactionRequestBean->merchantTxnRefNumber."|".$transactionRequestBean->amount."|".$transactionRequestBean->currencyCode."|".$transactionRequestBean->returnURL."|".$transactionRequestBean->shoppingCartDetails."|".$transactionRequestBean->TPSLTxnID."|".$transactionRequestBean->mobileNumber."|".$transactionRequestBean->txnDate."|".$transactionRequestBean->txn_type."|".$transactionRequestBean->bankCode."|".$transactionRequestBean->email."|".$transactionRequestBean->key."|".$transactionRequestBean->iv."|".$transactionRequestBean->custId."|".$transactionRequestBean->cardCVV."|".$transactionRequestBean->cardName."|".$transactionRequestBean->cardNo."|".$transactionRequestBean->cardExpMM."|".$transactionRequestBean->cardExpYY."|".$transactionRequestBean->webServiceLocator.PHP_EOL;
            ...
            <form method="post">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="SALE" name="txn_type" readonly>
                        </td>
                    </tr>
                    <tr>
