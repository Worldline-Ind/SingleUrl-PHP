...
if ($_POST && isset($_POST['submit'])) {
    ...
    $transactionRequestBean->txn_type = $val['txn_type'];
    $transactionRequestBean->txnSubType = $val['txnSubType'];
    ...
    $log  = "Name : ".$transactionRequestBean->customerName."; Date : ".date("F j, Y, g:i a")."; Request Data : ".$transactionRequestBean->merchantCode."|".$transactionRequestBean->ITC."|".$transactionRequestBean->customerName."|".$transactionRequestBean->requestType."|".$transactionRequestBean->merchantTxnRefNumber."|".$transactionRequestBean->amount."|".$transactionRequestBean->currencyCode."|".$transactionRequestBean->returnURL."|".$transactionRequestBean->shoppingCartDetails."|".$transactionRequestBean->TPSLTxnID."|".$transactionRequestBean->mobileNumber."|".$transactionRequestBean->txnDate."|".$transactionRequestBean->txn_type."|".$transactionRequestBean->bankCode."|".$transactionRequestBean->email."|".$transactionRequestBean->key."|".$transactionRequestBean->iv."|".$transactionRequestBean->txnSubType."|".$transactionRequestBean->cardCVV."|".$transactionRequestBean->cardName."|".$transactionRequestBean->cardNo."|".$transactionRequestBean->cardExpMM."|".$transactionRequestBean->cardExpYY."|".$transactionRequestBean->webServiceLocator.PHP_EOL;
        ...
        <div class="col-md-12">
            ...
            <form method="post">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        <td><label><span style="color:red">*</span> Request Type TWD <a href="#" data-toggle="tooltip" title="Type of request sent to Ingenico side"><span class="glyphicon glyphicon-info-sign"></span></a></label></td>
                        <td>
                            <input type="text" value="TWD" name="reqType" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td><label><span style="color:red">*</span> Transaction type</label></td>
                        <td>
                            <input type="text" value="PREAUTH" name="txn_type" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td><label><span style="color:red">*</span> Transaction sub type</label></td>
                        <td>
                            <input type="text" value="RESERVE" name="txnSubType" readonly>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="mrctCode" value="<?php echo $data['merchantCode'] ?>" required readonly /></td>
                    </tr>
                    <tr hidden>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="custname" value="test" require /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="card_name" value="johney" required /></td>
                    </tr>
                    <tr>
                        <td><label><span style="color:red">*</span> Card Number</label></td>
                        <td><input type="text" name="card_number" value="11111323213121111" required /></td>
                    </tr>
                    <tr>
                        <td><label><span style="color:red">*</span> Card CVV Number</label></td>
                        <td><input type="text" name="card_cvv" value="111" required /></td>
                    </tr>
                    <tr>
                        <td><label><span style="color:red">*</span> Card Exp MM</label></td>
                        <td><input type="text" name="card_exp_mm" value="11" required /></td>
                    </tr>
                    <tr>
                        <td><label><span style="color:red">*</span> Card Exp YY</label></td>
                        <td><input type="text" name="card_exp_yy" value="2020" required /></td>
                    </tr>
                    <tr>
