...
if ($_POST && isset($_POST['submit'])) {
    ...
    $log  = "Name : ".$transactionRequestBean->customerName."; Date : ".date("F j, Y, g:i a")."; Request Data : ".$transactionRequestBean->merchantCode."|".$transactionRequestBean->ITC."|".$transactionRequestBean->customerName."|".$transactionRequestBean->requestType."|".$transactionRequestBean->merchantTxnRefNumber."|".$transactionRequestBean->amount."|".$transactionRequestBean->currencyCode."|".$transactionRequestBean->returnURL."|".$transactionRequestBean->shoppingCartDetails."|".$transactionRequestBean->TPSLTxnID."|".$transactionRequestBean->mobileNumber."|".$transactionRequestBean->txnDate."|".$transactionRequestBean->bankCode."|".$transactionRequestBean->email."|".$transactionRequestBean->key."|".$transactionRequestBean->iv."|".$transactionRequestBean->custId."|".$transactionRequestBean->cardId."|".$transactionRequestBean->cardCVV."|".$transactionRequestBean->MMID."|".$transactionRequestBean->OTP."|".$transactionRequestBean->cardName."|".$transactionRequestBean->cardNo."|".$transactionRequestBean->cardExpMM."|".$transactionRequestBean->cardExpYY."|".$transactionRequestBean->webServiceLocator.PHP_EOL;
            ...
            <form method="post">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="TRC" name="reqType" readonly>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="tpsl_txn_id" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="date" name="txnDate" value="<?php echo $strCurDate; ?>" /></td>
                    </tr>
                    ...
                    <tr>
                        <td><label><span style="color:red">*</span> MMID</label></td>
                        <td><input type="text" name="mmid" value="" /></td>
                    </tr>
                    <tr>
                        <td><label><span style="color:red">*</span> OTP</label></td>
